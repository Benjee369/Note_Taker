...
import 'package:notes/features/notes/widgets/note_information_widget.dart';

class DesktopNoteDrawer extends StatelessWidget {
  const DesktopNoteDrawer({super.key});
